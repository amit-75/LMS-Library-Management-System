...
db = mysql.connector.connect(host = "localhost", user="root", password="12345qwert")
cur = db.cursor()
...
db = mysql.connector.connect(host = "localhost", user="root", password="12345qwert", database="library_ms")
cur = db.cursor()
